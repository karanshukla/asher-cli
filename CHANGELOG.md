...
- *(ci)* Only scan the PR title for major/breaking in auto-merge (#86)
- *(deps)* Update dependency pylitterbot to v2025.6.5 (#82)

### 👷 CI/CD

- Auto-merge non-major dependency PRs once checks pass (#85)

### 🔧 Miscellaneous

- *(renovate)* Squash automerged updates (#84)
- *(renovate)* Auto-merge non-major updates once checks pass (#83)
